...
| Claim | Evidence | Type: fact/inference/hypothesis | Confidence | Next test |
|---|---|---|---|---|
...
- Recruitment method:
- Commitment/payment:
- Success, repeat, pivot, and stop thresholds:
- Launch cohort and support plan:

## 6. First ten customers

| Customer source | Trigger/qualification | Action | Owner | Target date | Learning goal |
|---|---|---|---|---|---|
