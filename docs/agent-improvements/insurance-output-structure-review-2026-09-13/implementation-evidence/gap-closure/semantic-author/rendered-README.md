...
## Current decision
Investigate and revise before considering commitment. The conditional contribution per completed sale is EUR 50.0. Required monthly sales to cover the supplied fixed expenses and additional owner cash are 80, against a capacity limit of 60 completed sales per month. The model's capacity-meets-target result is false. The present assumptions therefore fail that capacity test even before demand is established.
