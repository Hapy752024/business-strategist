...
The model is transactional, monthly, denominated in EUR, with venture receipts rather than pass-through transaction value. Venture revenue per completed sale is EUR 150. Acquisition expense is EUR 15 per acquired customer; the conditional calculation allocates it once per sale. A repeat-purchase or multi-sale relationship has not been supplied and must not be assumed to improve the result. Acquisition channels, qualified audience denominator, spend efficiency and founder selling effort are unverified.

Conditional contribution per completed sale is EUR 100.0 after the supplied service, partner, refund and allocated acquisition expenses. Required monthly sales are 40 to cover fixed expenses plus additional owner cash. Capacity limit is 60 completed sales per month; capacity meets target: true. This conditional result passes the supplied capacity test and is not a forecast or purchase validation.
