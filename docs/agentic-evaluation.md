...
Outputs under `eval-workspaces/` are intentionally ignored. The committed configuration fixes the baseline, scope, and contract definitions so a run is reproducible.
