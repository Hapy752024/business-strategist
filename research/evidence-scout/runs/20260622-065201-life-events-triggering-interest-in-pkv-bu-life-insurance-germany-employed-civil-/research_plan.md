...
Test whether public evidence supports the hypothesis behind `life events triggering interest in PKV BU life insurance Germany employed civil servant self employed` for `employees above JAEG, Beamte or Referendare, and self-employed people in Germany considering PKV BU or life insurance`.
