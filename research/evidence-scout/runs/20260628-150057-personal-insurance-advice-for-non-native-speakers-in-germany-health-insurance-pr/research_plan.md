...
Test whether public evidence supports the hypothesis behind `personal insurance advice for non-native speakers in Germany: health insurance, private health insurance, disability insurance, life insurance, critical illness` for `Chinese and other non-English-native residents in Germany who need life, health, BU/disability, or dread disease/critical illness insurance`.
