...
Test whether public evidence supports the hypothesis behind `Tattoo risks, regret, removal, infection and aftercare concerns before getting a tattoo` for `Adults in France considering or recently getting a tattoo`.

## Current Assumptions

- Geography/language: `FR/fr`
...
- `regret tatouage`
- `"why is it so hard to" regret tatouage`
- `"how do you deal with" regret tatouage`
- `"frustrated" regret tatouage`
- `regret tatouage forum complaints`
