...
- Geography: `FR`
- Language: `fr`
- Segment phrase used for fit judgment: `Adults in France considering or recently getting a tattoo`
- Topic phrase: `TattooInsurance: risks and worries before getting a tattoo`
- Problem keywords: `tatouage infection,réaction allergique encre,regret tatouage,détatouage,tatouage raté,douleur tatouage,cicatrice tatouage,soins tatouage`
- Workaround keywords: `détatouage laser,dermatologue tatouage,crème cicatrice,réclamation tatoueur,assurance santé dermatologie`
...
- `tatouage infection`
- `"why is it so hard to" tatouage infection`
- `"how do you deal with" tatouage infection`
- `"frustrated" tatouage infection`
- `tatouage infection forum complaints`
- `tatouage infection reddit workflow`
- `réaction allergique encre`
- `"why is it so hard to" réaction allergique encre`
- `"how do you deal with" réaction allergique encre`
- `"frustrated" réaction allergique encre`
- `réaction allergique encre forum complaints`
- `réaction allergique encre reddit workflow`
