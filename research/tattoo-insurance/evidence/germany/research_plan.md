...
Test whether public evidence supports the hypothesis behind `TattooInsurance: risks and worries before getting a tattoo` for `Adults in Germany considering or recently getting a tattoo`.
