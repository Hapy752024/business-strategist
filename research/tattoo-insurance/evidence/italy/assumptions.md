...
- Geography: `IT`
- Language: `it`
- Segment phrase used for fit judgment: `Adults in Italy considering or recently getting a tattoo`
- Topic phrase: `TattooInsurance: risks and worries before getting a tattoo`
- Problem keywords: `tatuaggio infezione,reazione allergica inchiostro,rimorso tatuaggio,rimozione tatuaggio,tatuaggio fatto male,dolore tatuaggio,cicatrice tatuaggio,cura tatuaggio`
- Workaround keywords: `rimozione laser tatuaggi,dermatologo tatuaggio,crema cicatrici,reclamo tatuatore,assicurazione sanitaria dermatologia`
