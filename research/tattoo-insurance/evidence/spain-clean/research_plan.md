...
Test whether public evidence supports the hypothesis behind `Tattoo risks, regret, removal, infection and aftercare concerns before getting a tattoo` for `Adults in Spain considering or recently getting a tattoo`.
