...
Appends one JSONL event per call to projects/_infra/agentic-events.jsonl (gitignored,
...
def log_path() -> Path:
    ...
    return Path(__file__).resolve().parent.parent / "projects" / "_infra" / "agentic-events.jsonl"
